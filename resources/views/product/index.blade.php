                                                ...
                                                <a href="{{ route('product.show', $product->id) }}"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4"
                                                        ...
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0c" />
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                ...
                                                <form action="{{ route('product.delete', $product->id) }}" method="POST"
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4"
                                                            ...
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
                                                                d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6M9 7h1m-1 0a1 1 0 00-1 1v9M0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                        </svg>
                                                    </button>
                                                </form>
                                            </div>
